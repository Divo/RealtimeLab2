...
<!-- saved from url=(0105)http://glslang-library.googlecode.com/svn-history/r8/trunk/trunk/glslang/shaders/material/gooch.frag.glsl -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"><script type="text/javascript" src="chrome-extension://bfbmjmiodbnnpllbbbfblcplfjjepjdn/js/injected.js"></script></head><body style="zoom: 1;"><pre style="word-wrap: break-word; white-space: pre-wrap;">// Copyright (C) 2007 Dave Griffiths
